...
private val DarkColorScheme = darkColorScheme(
    ...
    surfaceDim = warmDarkNav,
    surfaceBright = warmDarkCard2,
    surfaceContainerLowest = warmDarkNav,
    surfaceContainerLow = warmDarkBase,
    surfaceContainer = warmDarkBar,
    surfaceContainerHigh = warmDarkCard,
    surfaceContainerHighest = warmDarkCard2,
    inverseSurface = lightPage,
    inverseOnSurface = foregroundWarmTertiary,
    error = statusDanger,
    onError = contentDarkPrimary,
    errorContainer = warmDarkCard2,
...
private val LightColorScheme = lightColorScheme(
    ...
    secondaryContainer = lightDeep,
    onSecondaryContainer = brandSecondary,
    tertiary = brandTertiary,
    onTertiary = foregroundLightPrimary,
    tertiaryContainer = lightDeep,
    onTertiaryContainer = brandTertiary,
    ...
    surfaceTint = brandPrimary,
    surfaceDim = lightDeep,
    surfaceBright = lightCard,
    surfaceContainerLowest = lightPage,
    surfaceContainerLow = lightBar,
    surfaceContainer = lightCard,
    surfaceContainerHigh = lightDeep,
